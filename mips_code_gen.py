            ...
            if ( list_peremenn[0] == ':=' ):
                if list_peremenn[1].isnumeric() and (tabl_sim[list_peremenn[2]][1] == 'int' or table_for_t[list_peremenn[2]][0]=='i'):
                    if (list_peremenn[2] in table_for_t.keys() and table_for_t[list_peremenn[2]][0]!=list_peremenn[2]):
                        file.write('\tli $' + list_peremenn[2] + ', ' + list_peremenn[1] + '\n')
                    else:
                        file.write('\tli $' + tabl_sim[list_peremenn[2]][0] + ', ' + list_peremenn[1] + '\n')
                    ...
                    if (list_peremenn[2] in table_for_t.keys() and table_for_t[list_peremenn[2]][0]!=list_peremenn[2]):
                        file.write('\tla $' + list_peremenn[2] + ', drob' + list_peremenn[1] + '\n')
                    else:
                        file.write('\tla $' + tabl_sim[list_peremenn[2]][0] + ', drob' + list_peremenn[1] + '\n')
                    ...
                    if (list_peremenn[1] in table_for_t.keys() and table_for_t[list_peremenn[1]][0]!=list_peremenn[1]):
                        if (list_peremenn[2] in table_for_t.keys() and table_for_t[list_peremenn[2]][0]!=list_peremenn[2]):
                            if table_for_t[list_peremenn[1]][0]=='r':
                                file.write('\tmov.s $f' +  list_peremenn[2][1:] + ', $f' + list_peremenn[1][1:] + '\n')
                            else:
                                file.write('\tmove $' + list_peremenn[2] + ', $f' + list_peremenn[1] + '\n')
                        elif list_peremenn[2] in tabl_sim.keys():
                            if table_for_t[list_peremenn[1]][0] == 'r':
                                file.write('\tmov.s $' + tabl_sim[list_peremenn[2]][0] + ', $f' + list_peremenn[1][1:] + '\n')
                            else:
                                file.write('\tmove $' + tabl_sim[list_peremenn[2]][0] + ', $' + list_peremenn[1] + '\n')
                    elif (list_peremenn[1] in tabl_sim.keys()):
                        if (list_peremenn[2] in tabl_sim.keys()):
                            if tabl_sim[list_peremenn[2]][1] =='float':
                                file.write('\tmov.s $' + tabl_sim[list_peremenn[2]][0] + ', $' + tabl_sim[list_peremenn[1]][0] + '\n')
                            else:
                                file.write('\tmove $' + tabl_sim[list_peremenn[2]][0] + ', $' + tabl_sim[list_peremenn[1]][0] + '\n')
                else:
                    if (list_peremenn[2] in tabl_sim.keys()):
                        file.write('\tmove $' + list_peremenn[2] + ', $' + list_peremenn[1] + '\n')
                    elif (list_peremenn[2] in tabl_sim.keys()):
                        file.write('\tmove $' + tabl_sim[list_peremenn[2]][0] + ', $' + list_peremenn[1] +'\n')
                    else:
                        file.write('\tmove $' + list_peremenn[2] + ', $' + list_peremenn[1] + '\n')
                ...
                if not(number_chek(list_peremenn[1]) or number_chek(list_peremenn[2])):
                        if(list_peremenn[1].isnumeric() or tabl_sim[list_peremenn[1]][1]=='int' or table_for_t[list_peremenn[1]][0]=='i') and (list_peremenn[2].isnumeric() or tabl_sim[list_peremenn[2]][1]=='int'or table_for_t[list_peremenn[kak]][0]=='i'):
                            if list_peremenn[1].isnumeric():
                                # file.write('\tli $t0, '+ list_peremenn[2] + '\n')
                                arg_left = '$t0'
                                if list_peremenn[2].isnumeric():
                                    file.write('\tli $t1, '+ list_peremenn[1]+ '\n')
                                    arg_right = '$t1'
                                    file.write('\t' + mult + arg_left + ', ' + arg_right + '\n')
                                ...
                                if list_peremenn[2].isnumeric():
                                    file.write('\t' + kak2 + list_peremenn[2]+ '\n')
                                    arg_right = '$t1'
                                    file.write('\t' + mult + arg_left + ', ' + arg_right + '\n')
                                elif (list_peremenn[2] in tabl_sim and tabl_sim[list_peremenn[2]][1] == 'int'):
                                    arg_right = '$' + tabl_sim[list_peremenn[2]][0]
                                    ...
                                    arg_right = '$' + list_peremenn[2]
                                    file.write('\t' + mult + arg_left + ', ' + arg_right + '\n')
                                file.write('\tmflo $' + list_peremenn[3] + '\n')
                elif number_chek(list_peremenn[1]):
                    file.write('\tli.s $f0, ' + list_peremenn[1] + '\n')
                    arg_left = '$f0'
                    if number_chek(list_peremenn[2]):
                        file.write('\tli.s $f1, ' + list_peremenn[2] + '\n')
                        arg_right = '$f1'
                        file.write('\t' + mults+ list_peremenn[3][1:]+', '  + arg_left + ', ' + arg_right + '\n')
                    ...
                    if (number_chek(list_peremenn[1]) or number_chek(list_peremenn[2])):
                        ...
                        if number_chek(list_peremenn[2]):
                            file.write('\tli.s $f1, ' + list_peremenn[2] + '\n')
                            arg_right = '$f1'
                            file.write('\t' + addus + list_peremenn[3][1:] + ', ' + arg_left + ', ' + arg_right + '\n')
                        ...
                        if (list_peremenn[1].isnumeric() or tabl_sim[list_peremenn[1]][1] == type_p or table_for_t[list_peremenn[1]][0] == t_p) and (list_peremenn[2].isnumeric() or tabl_sim[list_peremenn[2]][1] == type_p or table_for_t[list_peremenn[kek]][0] == t_p):
                            if list_peremenn[1].isnumeric():
                                file.write('\tli $t0, ' + list_peremenn[1] + '\n')
                                arg_left = '$t0'
                                if list_peremenn[2].isnumeric():
                                    file.write('\t' + kak2 + list_peremenn[2] + '\n')
                                    arg_right = '$t1'
                                    file.write('\t' + addu + list_peremenn[3] + ', ' + arg_left + ', ' + arg_right + '\n')
                                elif (list_peremenn[2] in tabl_sim and tabl_sim[list_peremenn[2]][1] == 'int'):
                                    arg_right = '$' + tabl_sim[list_peremenn[2]][0]
                                    file.write('\t' + addu + list_peremenn[3] + ', ' + arg_left + ', ' + arg_right + '\n')
                                elif (table_for_t[list_peremenn[2]][0] == 'i'):
                                ...
                                if list_peremenn[2].isnumeric():
                                    file.write('\tli $t1, ' + list_peremenn[2] + '\n')
                                    arg_right = '$t1'
                                    file.write('\t' + addu + list_peremenn[3] + ', ' + arg_left + ', ' + arg_right + '\n')
                                elif (list_peremenn[2] in tabl_sim and tabl_sim[list_peremenn[2]][1] == 'int'):
                                    arg_right = '$' + tabl_sim[list_peremenn[2]][0]
                ...
                file.write('\tla $' + list_peremenn[3] + ', false\n')
                file.write('\t' + flagok1 + tabl_sim[list_peremenn[1]][0] + ', $' + tabl_sim[list_peremenn[2]][0] + ', SKIP'+str(skip_count) + '\n')
                file.write('\tla $' + list_peremenn[3] + ', true\n')
                file.write('SKIP'+str(skip_count) + ':\n')
                skip_count = skip_count + 1
            elif (list_peremenn[0] == 'and' or list_peremenn[0] == 'or'):
                file.write('\t' + list_peremenn[0] + ' $' + list_peremenn[3] + ', $' + list_peremenn[1] + ', $' + list_peremenn[2] + '\n')
            elif (list_peremenn[0] == 'not'):
                index = list_peremenn[2][1:]
                index = int(index) + 1
                temp = 't' + str(index)
                file.write('\tla $' + temp + ' false\n')
                file.write('\tnor $' + list_peremenn[2] + ', $' + list_peremenn[1] + ', $' + temp + '\n')
                ...
                file.write('\tbeq $' + temp + ', $' + list_peremenn[1] + ', ' + list_peremenn[3] + '\n')
                file.write('L' + str(poka_flag) + ':\n')
                poka_flag = poka_flag + 1
            elif (list_peremenn[0] == 'GOTO'):
                if (list_peremenn[1] == 'a_kogda'):
                        print('after false')
                        file.write('\tj L' + str(poka_flag - 1) + '\n')
                elif (list_peremenn[1] == 's_kogda'):
                    file.write('\tj L' + str(poka_flag - 2) + '\n')
                else:
                    file.write('\tj ' + list_peremenn[1] + '\n')
            elif (list_peremenn[0] == 'break'):
                file.write('\tj L' + str(poka_flag - 3) + '\n')
            elif (list_peremenn[0] == 'continue'):
                file.write('\tj L' + str(poka_flag - 4) + '\n')
                ...
                if (list_peremenn[1].startswith('\"') and list_peremenn[1].endswith('\"')):
                    ...
                    file.write('\tli $v0, 4\n')
                    file.write('\tla $a0, ' + list_peremenn[1] + '\n')
                    file.write('\tsyscall\n')
                    ...
                    data=data+'\tdrob'+ list_peremenn[1] +': .float '+list_peremenn[1]+'\n'
                    file.write('\tli $v0, 2\n')
                    file.write('\tlwc1 $f12, drob' + list_peremenn[1] + '\n')
                    file.write('\tsyscall\n')
                elif (list_peremenn[1] in tabl_sim and tabl_sim[list_peremenn[1]][1] == 'int'):
                    file.write('\tli $v0, 1\n')
                    file.write('\tla $a0, ' + '($' + tabl_sim[list_peremenn[1]][0] + ')\n')
                    file.write('\tsyscall\n')
                elif (list_peremenn[1] in tabl_sim and tabl_sim[list_peremenn[1]][1] == 'float'):
                    file.write('\tli $v0, 2\n')
                    file.write('\tlwc1 $f12, ($' + tabl_sim[list_peremenn[1]][0] + ')\n')
                    file.write('\tsyscall\n')
            elif (list_peremenn[0] == 'vozv'):
                file.write('\tmove $t9, $' + list_peremenn[1] + '\n' )
                file.write('\tjr $ra\n')
            elif (list_peremenn[0] == 'Call'):
                args = list_peremenn[2:len(list_peremenn)-1]
                for i in range(len(args)):
                    file.write('\tmove $a' + str(i) + ', $' + tabl_sim[args[i]][0] + '\n')
                file.write('\tjal ' + list_peremenn[1] + '\n')
                file.write('\tmove $' + list_peremenn[len(list_peremenn)-1] + ', $t9\n')
    file.write('END:\n')
    file.write(data)
    file.close()
